			...
			<div class="row">
				<div class="col-lg-6 col-md-6 text-center">
					<div class="inner-column">
						...
						<p><b><i>We at Leisure Square Grub & wine would love to serve you yummy dishes straight from our kitchen ready for you.we will fulfill you  hunger needs and ensure that we leave you licking your fingers and asking for more yummy dishes!</i></b> </p>
						<br><p><b><i>We believe passionately in great bargains and excellent service ,which is why we commit ourselves to giving you the best of both.If you're looking for something new,you're in the right place.we strive to be industrious and innovative,offering our customers something they want,putting their desires at the top of our priority list.</i></b></p>
						                            <p><b>so hurry!Order now!</b></p>
						<!--<a class="btn btn-lg btn-circle btn-outline-new-white" href="#"> Comment</a> -->
					</div>
				</div>
				<div class="col-lg-6 col-md-6">
					<img src="images/img28.jpg" style="height: 450px; width: 100%" class="img-fluid">
				</div>
				<div class="col-md-12">
					<div class="inner-pt">
						<p><b><i>Making way for a hearty meal is Leisure Square Banglore. This place is synonymous with delicious food that can satiate all food cravings. It is home to some of the most appreciated cuisines. So as to be able to cater to a large number of diners, it occupies a favourable location at Karnataka.178/6 14th main road,20th,50th Main Rd,Kumaraswamy Layout,Bengaluru-560078 is where one can visit the venue. Courtesy to this strategic location, foodies in and around the neighborhood can walk in to this eating house conveniently without facing any hassles related to commuting to this part of the city. It is one of the most sought after Restaurants in Banglore.</i></b></p>
					</div>
				</div>
			</div>
		</div>
